...
public class MainActivity extends AppCompatActivity
    ...
    private Marker mRawLocationMarker;
    private Circle mRawLocationCircle;
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        if (item.getItemId() == R.id.option_get_place) {
            if (!mDataCollectionManager.isCollectionStarted()) {
                mDataCollectionManager.startCollection();
                item.setTitle("Stop collection");

                Toast.makeText(this,
                    "Collection started",
                    Toast.LENGTH_SHORT).show();
            } else {
                mDataCollectionManager.stopCollectionAndSave();
                item.setTitle("Start collection");
                Toast.makeText(this,
                        "Collection stopped and saved",
                        Toast.LENGTH_SHORT).show();
            }
        }
        return true;
    ...
    public void onMapReady(GoogleMap map) {
        ...
        if (PackageManager.PERMISSION_GRANTED==
            ...
            mDataCollectionManager = new DataCollectionManager(this);
        } else {
            //requestPermission(android.Manifest.permission.ACCESS_FINE_LOCATION, LOCATION_PERMISSION_REQUEST_CODE);
    ...
    private void getDeviceLocation() {
         ...
         */
        Log.d("MainActivity","getDeviceLocation()");
        try {
    ...
    public void OnGPSSignalCollected(GPSCollectedEvent event) {
        Log.d("GPSFragment", "location received");
        //mDataCollectionManager.OnGPSSignalCollected(event);
        ...
        if (mRawLocationMarker ==null) {
            ...
            //Toast.makeText(this,
            //        (int)location.getAltitude()+(" [sat="+location.getExtras().getInt("satellitesInFix")+"] acc="+location.getAccuracy()),
            //        Toast.LENGTH_SHORT).show();
        }
        else {
            mRawLocationMarker.setPosition(latLng);
            mRawLocationCircle.setCenter(latLng);
            mRawLocationCircle.setRadius(location.getAccuracy());
            //Toast.makeText(this,
            //        (int)location.getAltitude()+(" [sat="+location.getExtras().getInt("satellitesInFix")+"] acc="+location.getAccuracy()),
            //        Toast.LENGTH_SHORT).show();
        }
